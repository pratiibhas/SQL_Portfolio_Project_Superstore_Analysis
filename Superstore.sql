...
FROM superstore 
group by 1; 
/* Rolling time windows are used to smooth out the noise in dataset but Depending on the dataset is sparse or not this may or may not be the best approach, since
